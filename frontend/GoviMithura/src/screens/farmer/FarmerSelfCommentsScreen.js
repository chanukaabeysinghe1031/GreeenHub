...
const SelfCommentsScreen =  ({route,navigation}) => {
    ...
    return(
        <View style={styles.container}>
                ...
                <TouchableOpacity 
                    ...
                    onPress={
                        ()=>navigation.navigate('SelfPosts',{
                            user:data.user
                        })
                    }
                >
                        <Text style={styles.loginText}>Back to your posts</Text>
                </TouchableOpacity>
...
export default  SelfCommentsScreen;